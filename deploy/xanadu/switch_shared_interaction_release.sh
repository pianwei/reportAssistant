...
BACKUP_NAME="due-diligence-assistant-pre-shared-interaction-20260812"
APP_ROOT="/home/pianwei/apps/due-diligence-assistant"
RELEASE_ROOT="$APP_ROOT/releases/shared-interaction-20260812"
BASE_IMAGE="due-diligence-assistant:20260812-code-flash-v1"
IMAGE="due-diligence-assistant:20260812-shared-interaction-v3"
ARCHIVE="$APP_ROOT/xanadu-shared-interaction-20260812.tar.gz"
...
for _ in {1..90}; do
  ...
  if [[ "$health" == *'"status":"ready"'* ]] \
    ...
    trap - ERR
    echo "$health"
    echo "shared interaction release container is healthy"
    exit 0
  fi
  sleep 1
done
